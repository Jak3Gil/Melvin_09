#!/bin/bash
# Demonstrate ML-style output generation with many inputs

BRAIN="ml_demo_brain.m"
rm -f "$BRAIN"

echo "=========================================="
echo "Melvin ML-Style Output: Learning Progression"
echo "=========================================="
echo ""
echo "Feeding many inputs to strengthen patterns..."
echo "Watch how outputs emerge as patterns mature."
echo ""
...
gcc -O3 -o ml_demo ml_demo.c melvin.o melvin_in_port.o melvin_out_port.o -lm -lpthread 2>&1 | grep -v "warning: unused"
./ml_demo
