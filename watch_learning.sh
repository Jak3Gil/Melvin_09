#!/bin/bash
# Watch how the system learns and how outputs evolve

BRAIN="learning_brain.m"
rm -f "$BRAIN"

echo "=========================================="
echo "Melvin: Watching Learning & Output Evolution"
echo "=========================================="
echo ""
echo "This shows how the system learns patterns and how outputs change."
echo "Notice: Nodes and edges grow as patterns are learned."
echo ""

# Create a simple program that shows learning progression
cat > watch_learning.c << 'CCODE'
#include "melvin.h"
...
gcc -O3 -o watch_learning watch_learning.c melvin.o melvin_in_port.o melvin_out_port.o -lm -lpthread 2>&1 | grep -v "warning: unused"
./watch_learning
